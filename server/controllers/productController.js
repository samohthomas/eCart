...
module.exports = {
    ...
    create: function (req, res) {
        var category = {main:req.body.category,sub:req.body.subcat};
        var policy = {description:req.body.policy,services:req.body.services,days_before:req.body.days_before};
